...
```bash
TRANSITION=$(node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
