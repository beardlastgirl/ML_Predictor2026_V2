...
```bash
INIT=$(node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
