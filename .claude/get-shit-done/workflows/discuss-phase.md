...
<required_reading>
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/domain-probes.md
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/gate-prompts.md
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
