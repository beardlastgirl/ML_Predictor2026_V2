...
INSTALL_JS_GLOBAL="I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
