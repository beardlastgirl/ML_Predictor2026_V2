...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = I:/Scripts/ML_Predictor2026_V2/.gemini
                  → checks I:/Scripts/ML_Predictor2026_V2/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = I:/Scripts/ML_Predictor2026_V2/.gemini/get-shit-done
                  → writes to I:/Scripts/ML_Predictor2026_V2/.gemini/get-shit-done/hooks/
...
```bash
INIT=$(node "I:/Scripts/ML_Predictor2026_V2/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "I:/Scripts/ML_Predictor2026_V2/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "I:/Scripts/ML_Predictor2026_V2/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
