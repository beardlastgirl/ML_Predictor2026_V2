...
Reference full template: `C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/state.md`.
