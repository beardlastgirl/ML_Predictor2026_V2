...
<execution_context>
@C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/Scripts/ML_Predictor2026_V2/.codex/get-shit-done/workflows/check-todos.md`.
