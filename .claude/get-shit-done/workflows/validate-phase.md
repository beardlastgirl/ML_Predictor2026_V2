...
```
Task(
  prompt="Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/VALIDATION.md`
