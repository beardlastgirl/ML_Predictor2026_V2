...
<execution_context>
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/workflows/docs-update.md end-to-end.
