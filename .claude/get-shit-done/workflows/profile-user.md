...
Key references:
- @I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md" "I:/Scripts/ML_Predictor2026_V2/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to I:/Scripts/ML_Predictor2026_V2/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at I:/Scripts/ML_Predictor2026_V2/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to I:/Scripts/ML_Predictor2026_V2/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="I:/Scripts/ML_Predictor2026_V2/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   I:/Scripts/ML_Predictor2026_V2/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        I:/Scripts/ML_Predictor2026_V2/.claude/CLAUDE.md
```
