...
<reference>
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/user-profiling.md` to load:
