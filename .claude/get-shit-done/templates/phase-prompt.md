...
<!-- For checkpoint task examples and patterns, see @C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
