...
Reference full template: `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/state.md`.
