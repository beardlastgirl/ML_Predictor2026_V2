...
Intel system is disabled. To activate:
  ...
  node I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
