...
- **Global scope**: `I:/Scripts/ML_Predictor2026_V2/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `I:/Scripts/ML_Predictor2026_V2/.claude/notes/`)
...
2. Glob `I:/Scripts/ML_Predictor2026_V2/.claude/notes/*.md` (if directory exists) — global notes
...
Global (I:/Scripts/ML_Predictor2026_V2/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `I:/Scripts/ML_Predictor2026_V2/.claude/notes/` — works in any directory
