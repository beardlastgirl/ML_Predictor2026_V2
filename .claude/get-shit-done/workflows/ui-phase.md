...
```markdown
Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-ui-checker.md for instructions.
