...
- Usage: Reference from command with `@C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Scripts/ML_Predictor2026_V2/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Scripts/ML_Predictor2026_V2/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
