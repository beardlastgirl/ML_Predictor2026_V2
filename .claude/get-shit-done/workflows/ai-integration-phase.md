...
<required_reading>
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/ai-frameworks.md
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read I:/Scripts/ML_Predictor2026_V2/.claude/agents/gsd-eval-planner.md for instructions.
