...
Use template from `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
