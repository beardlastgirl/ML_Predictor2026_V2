...
@I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "I:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
