...
<required_reading>
@C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "C:/Scripts/ML_Predictor2026_V2/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
